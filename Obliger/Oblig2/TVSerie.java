...
public class TVSerie {
    ...
    final ArrayList<Episode> episoder = new ArrayList<>();
    private int gjennomsnittligSpilletid;
    private int antallSessonger = 0;

    public TVSerie(String tittel, String beskrivelse, int utgivelsesår, int utgivelsesmåned, int utgivelsesdag) {
        this.tittel = tittel;
        this.beskrivelse = beskrivelse;
        this.utgivelsesdato = LocalDate.of(utgivelsesår, utgivelsesmåned, utgivelsesdag);
    }
    ...
    public void setUtgivelseDato(int utgivelsesår, int utgivelsesmåned, int utgivelsesdag) {
        this.utgivelsesdato = LocalDate.of(utgivelsesår, utgivelsesmåned, utgivelsesdag);
    }
